...
import 'package:historiskasthlm_app/maps/secrets.dart';
...
class _DistanceState extends State<Distance> {
  CameraPosition _initialLocation = CameraPosition(
      target: LatLng(59.3294, 18.0686), zoom: 15);
    ...
    try {
      ...
      if (startPlacemark != null && destinationPlacemark != null) {
        ...
        for (int i = 0; i < polylineCoordinates.length - 1; i++) {
          distanceInMeters +=
              _coordinateDistance((polylineCoordinates[i].latitude),
...
// https://stackoverflow.com/a/54138876/11910277
  double _coordinateDistance(double lat1, double lon1, double lat2,
      double lon2) {
